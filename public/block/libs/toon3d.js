...
class JoyStick{
	constructor(options){
		...
		circle.style.cssText = "position:absolute; bottom:35px; width:80px; height:80px; ; border:#9e9e9e solid; border-radius:50%; left:50%; transform:translateX(-50%); mix-blend-mode: multiply;";
		const thumb = document.createElement("div");
		thumb.style.cssText = "position: absolute; left: 20px; top: 20px; width: 40px; height: 40px; border-radius: 50%; background:#9e9e9e; mix-blend-mode: multiply;";
